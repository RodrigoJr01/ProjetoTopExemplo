...
using ProjetoExemploTop.Repositorio;
using System.Security.Claims;

namespace ProjetoExemploTop.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Logar(Usuario model) // Alterado para LoginViewModel
        {
